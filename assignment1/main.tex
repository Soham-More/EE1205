...
\[ x(n) = a_1r^{n - 1}u[n]\ref{fig:img1} \] where $u[0] = 0$.
...
\begin{figure*}
    \centering
    \includegraphics[width=0.7\textwidth]{figs/a.png}
    \caption{Plot of $x_a$(n) from n = -6 to 6}
    \label{fig:img1}
\end{figure*}

\begin{figure*}
    \centering
    \includegraphics[width=0.7\textwidth]{figs/b.png}
    \caption{Plot of $x_b$(n)}
    \label{fig:img2}
\end{figure*}

\begin{figure*}
    \centering
    \includegraphics[width=0.7\textwidth]{figs/c.png}
    \caption{Plot of $x_c$(n)}
    \label{fig:img3}
\end{figure*}

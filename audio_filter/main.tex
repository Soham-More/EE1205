...
\item The Audio file is taken from:
\begin{lstlisting}
https://github.com/Soham-More/EE1205/blob/main/audio_filter/audio/alt.wav
\end{lstlisting}

\item 
A Python Code is written to achieve Audio Filtering \label{prob:audio_filter_problem} \label{prob:audio_filter}
\lstinputlisting{./codes/filter.py}

\item The audio file is analyzed using spectrogram using the online platform \href{https://academo.org/demos/spectrum-analyzer}{\url{https://academo.org/demos/spectrum-analyzer}}.\\

The orange, yellow regions have high amplitudes and purple small amplitudes.
